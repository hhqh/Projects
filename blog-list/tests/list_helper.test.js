...
describe('total likes', () => {
    ...
    test('when list has six blogs, equals to the total of that', () => {
...
describe('most likes', () => {
    ...
    test('when list has six blogs, equals to the most likes of that', () => {
...
describe('most blogs', () => {
    ...
    test('when list has six blog, equals the most blogs of that', () => {
...
describe('most likes', () => {
    ...
    test('when list has six blog, equals the most likes of that', () => {
