...
namespace Game.Models
{
    ...
    public class ScoreModel : BaseModel<ScoreModel>
    {
        ...
        // Add Characters to the List in a round
        [Ignore]
        public List<PlayerInfoModel> CharacterModelRoundDeathList { get; set; } = new List<PlayerInfoModel>();

        // Add Monsters to the List in a round
        [Ignore]
        public List<PlayerInfoModel> MonsterModelRoundDeathList { get; set; } = new List<PlayerInfoModel>();
