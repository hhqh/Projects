...
namespace Game.Views
{
    ...
    public partial class ScoreIndexPage : ContentPage
    {
        ...
        /// <summary>
        /// Update score in list by swiping right
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public async void Swipe_Update(object sender, EventArgs e)
        {
            var selectedItem = (sender as SwipeItem).BindingContext as ScoreModel;

            await Navigation.PushModalAsync(new NavigationPage(new ScoreUpdatePage(new GenericViewModel<ScoreModel>(selectedItem))));
            _ = await Navigation.PopAsync();
        }

        /// <summary>
        /// Delete score in list by swiping right
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public async void Swipe_Delete(object sender, EventArgs e)
        {
            ...
            await Navigation.PushModalAsync(new NavigationPage(new ScoreDeletePage(new GenericViewModel<ScoreModel>(selectedItem))));
            _ = await Navigation.PopAsync();
        }
    }
}