...
namespace Game.Views
{
    ...
    public partial class BattleSettingsPage : ContentPage
    {
        ...
        /// <summary>
        /// Toggle to make round choose order in order of smallest to biggest speed
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void ReverseSpeedOrder_Toggled(object sender, EventArgs e)
        {
            // Flip the settings
            if (ReverseSpeedOrderSwitch.IsToggled == true)
            {
                BattleEngineViewModel.Instance.Engine.EngineSettings.BattleSettingsModel.ReverseSpeedOrder = true;
                return;
            }

            BattleEngineViewModel.Instance.Engine.EngineSettings.BattleSettingsModel.ReverseSpeedOrder = false;
        }
