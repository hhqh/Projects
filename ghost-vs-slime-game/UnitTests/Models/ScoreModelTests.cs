...
namespace UnitTests.Models
{
    ...
    public class ScoreModelTests
    {
        ...
        public void ScoreModel_Set_Default_Should_Pass()
        {
            ...
            result.MonsterModelRoundDeathList = new List<PlayerInfoModel> { new PlayerInfoModel(new MonsterModel()) };
            result.CharacterModelRoundDeathList = new List<PlayerInfoModel> { new PlayerInfoModel(new CharacterModel()) };
