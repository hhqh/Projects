...
namespace UnitTests.Views
{
    ...
    public class BattleSettingsPageTests
    {
        ...
        [Test]
        public void BattleSettingsPage_ReverseSpeedOrder_Toggled_True_Default_Should_Pass()
        {
            // Arrange

            var control = (Switch)page.FindByName("ReverseSpeedOrderSwitch");
            var current = control.IsToggled;

            ToggledEventArgs args = new ToggledEventArgs(current);
            page.ReverseSpeedOrder_Toggled(null, args);
        ...
        [Test]
        public void BattleSettingsPage_ReverseSpeedOrder_Toggled_Default_Should_Pass()
        {
            // Arrange
