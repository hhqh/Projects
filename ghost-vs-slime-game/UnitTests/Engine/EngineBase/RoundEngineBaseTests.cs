...
namespace UnitTests.Engine.EngineBase
{
    ...
    public class RoundEngineBaseTests
    {
        ...
        public async Task RoundEngine_GetItemFromPoolIfBetter_Valid_Head_Better_Should_Pass()
        {
            ...
            var item2 = new ItemModel { Attribute = AttributeEnum.CurrentHealth, Value = 1, Location = ItemLocationEnum.Head };
        ...
        [Test]
        public async Task RoundEngine_GetItemFromPoolIfBetter_Valid_Head_OneItem_Should_Pass()
        {
            Engine.EngineSettings.MonsterList.Clear();
            ...
            var item1 = new ItemModel { Attribute = AttributeEnum.CurrentHealth, Value = 1, Location = ItemLocationEnum.Head };
            var item2 = new ItemModel { Attribute = AttributeEnum.Speed, Value = 1, Location = ItemLocationEnum.Head };
            ...
            // Assert
            Assert.AreEqual(true, result);
            Assert.AreEqual(item1.Id, CharacterPlayer.Head); 
        }
        ...
        public async Task RoundEngine_GetItemFromPoolIfBetter_InValid_Right_Finger_Empty_Should_Pass()
        {
            ...
            var item2 = new ItemModel { Attribute = AttributeEnum.CurrentHealth, Value = 20, Location = ItemLocationEnum.Finger };
            ...
            // Assert
            Assert.AreEqual(true, result);
            Assert.AreEqual(item2.Id, CharacterPlayer.RightFinger);    // The 2nd item has the highest health attribute
        }
        ...
        [Test]
        public async Task RoundEngine_GetItemFromPoolIfBetter_InValid_Head_WorseAttribute_Should_Skip()
        {
            Engine.EngineSettings.MonsterList.Clear();
            ...
            var item1 = new ItemModel { Attribute = AttributeEnum.Defense, Value = 1, Location = ItemLocationEnum.Head };
            var item2 = new ItemModel { Attribute = AttributeEnum.Attack, Value = 20, Location = ItemLocationEnum.Head };
