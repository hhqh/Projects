...
namespace UnitTests.Engine.EngineGame
{
    ...
    public class RoundEngineGameTests
    {
        ...
        [Test]
        public void RoundEngine_AddMonstersToRound_Every_Fifth_Round_Creates_Boss_IsValid()
        {
            // Arrange
            var oldRound = Engine.EngineSettings.BattleScore.RoundCount;
            Engine.EngineSettings.BattleScore.RoundCount = 5;


            // Act
            Engine.Round.AddMonstersToRound();
            var bossName = "Big Boss 01";

            // Reset
            Engine.EngineSettings.BattleScore.RoundCount = oldRound;


            //A Assert
            Assert.AreEqual(Engine.EngineSettings.MonsterList[0].Name, bossName);
        }
        #endregion
    }
